...
export default authMiddleware(async function handler(req, res) {
  ...
  let { topics, numberOfQuestions, selectedDifficulty, module } = req.body;
    ...
    const response = await axios.post(
      `${process.env.AI}`,
      {
        ...
        messages: [
          {
            role: "system",
            content: `You have generated a learning module for topics:${topics.join(', ')}
            learning module : ${module}

            now Generate ${numberOfQuestions} multiple-choice questions, difficultyLevel: ${selectedDifficulty} from the generated module. The questions should:
...
- Question should not be outside from the module.
