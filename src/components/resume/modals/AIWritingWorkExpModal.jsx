...
export default function AIWritingWorkExpModal({ onClose, initialText, onSave,workExp }) {
  ...
  const handleAction = async (action) => {
    try {
      ...
      // API call
      const response = await apiClient.post("/api/resume/ai/writeWithAiWorkExp", payload)
