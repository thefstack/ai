...
const QuizContentModal = ({ type }) => {
  
  const { isModalOpen,setIsModalOpen, isContentModal,setIsContentModal, isFileModal,setIsFileModal, isInstitutionalModal, setIsInstitutionalModal}=useQuiz();
  ...
  return (
    isPlanExpiryModalOpen ?
    <PlanExpiryModal onClose={() => setIsPlanExpiryModalOpen(false)} type={type} />
    :
      ...
      <div className={styles.modalContainer}>
        ...
        <div className={styles.optionsContainer}>
          <button className={styles.optionCard} onClick={handlePublicContent}>
            ...
            <p>Create quiz on any topic using public content and knowledge.</p>
          </button>
          <button className={styles.optionCard} onClick={handlePersonalContent}>
            <Lock className={styles.icon} />
            <h3>Personal Content</h3>
            <p>Create Quiz from the content you provide, such as course notes.</p>
          </button>
...
export default QuizContentModal;
